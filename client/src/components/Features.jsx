      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="md:col-span-2 relative overflow-hidden bg-[#0d1424]/80 backdrop-blur-xl border border-[var(--border)] rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] group hover:border-[var(--border)] transition-colors"
          >
            ...
            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-2 font-sans">O(N) Matching Engine</h3>
          ...
          >
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-3 font-sans leading-tight">Deterministic AI Explanations</h3>
            ...
            <div className="mt-8 bg-[#040914]/80 border border-[var(--border-sub)] rounded-xl p-4 shadow-inner">
          ...
          <motion.div
            variants={itemVariants}
            className="relative overflow-hidden bg-[#0d1424]/80 backdrop-blur-xl border border-[var(--border)] rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] group hover:border-[var(--border)] transition-colors"
          >
            ...
            <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2 font-sans">Zero Forced Matches</h3>
          ...
          >
            <div className="w-12 h-12 mb-4 rounded-xl bg-amber-500/10 flex items-center justify-center border border-amber-500/30 shadow-[0_0_15px_rgba(245,158,11,0.2)] group-hover:shadow-[0_0_25px_rgba(245,158,11,0.4)] transition-shadow">
              <Clock className="text-[var(--status-warning)] w-6 h-6 drop-shadow-[0_0_5px_#fbbf24]" />
            </div>
            
            <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2 font-sans">T+2 Window Tolerance</h3>
            <p className="text-slate-400 font-serif italic text-sm leading-relaxed">
